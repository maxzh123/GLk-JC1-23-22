...
public class Sample6 {//Сообщаем компилятору что Это класс и мы дали ему имя Sample6
    ...
    private static boolean isPrime(int number){
        ...
        if (number==2){ //Если число которое нам передали одно из 0 1 2
            return true;//возвращаем да
        }else{//иначе
            for(int i=2;i<=s;i++){//для целочисленного i установить значение 2;выполнять блок пока i меньше number; после каждого исполнения увеличить i на 1
                count++;
